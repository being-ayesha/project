					...
					<div class="card-body">
						...
						<form action="{{url('seller/settings/account')}}" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
					        	 	...
					        	 	<p style="font-size: 14px;font-weight:700;color: #797979">Store URL:</p><span style="font-size: 14px;"><a href="{{url('sellers')}}/{{Auth::user()->username}}" target="_blank">{{url('sellers')}}/{{Auth::user()->username}}</a></span> 
					        	</div>
					        	<div class="form-group">
