...
use Auth;
class AffiliatePayoutsDataTable extends DataTable
{
   /**
    ...
    {
        $query = AffiliatePayout::where(['seller_id'=>Auth::user()->id])->with('paymentMethod');
        //dd($query->get());
    ...
    {
        return $this->builder()
            ->addColumn(['data' => 'seller_id', 'name' => 'seller_id', 'title' => 'Affiliate Username'])
